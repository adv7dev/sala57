...
/// Functions to query MeditacaoRecords (as a Stream and as a Future).
Stream<List<MeditacaoRecord>> queryMeditacaoRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(MeditacaoRecord.collection, MeditacaoRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<MeditacaoRecord>> queryMeditacaoRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(MeditacaoRecord.collection, MeditacaoRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<MeditacaoRecord>> queryMeditacaoRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
