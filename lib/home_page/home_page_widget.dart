                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Container(
                                                                                ...
                                                                                child: Stack(
                                                                                  children: [
                                                                                    if (!(listViewUserPostsRecord.likes.toList()?.contains(currentUserReference)) ?? true)
                                                                                      Align(
                                                                                        ...
                                                                                        child: InkWell(
                                                                                          onTap: () async {
                                                                                            ...
                                                                                            await listViewUserPostsRecord.reference.update(userPostsUpdateData);
